$(document).ready(function () {
    ...
    $tablaRemisiod.DataTable({
        ...
        columns: [
            ...
            },
            {
                data: null,
                render: function (data, type, row) {
                    return `<a href="/UserPages/DetalleTicketJoyUser?idFolio=${row.folio_factura}&almacen=${row.almacen}" target="_blank" class="btn btn-grey"><i class="fas fa-info-circle"></i> Detalle</a>`;
                },
                orderable: false
            },
    ...
    $filtrarBusqueda.on('submit', function (event) {
        ...
        $.ajax({
            url: '/AdminPages/filtrarTablaCTJoy',
            type: 'POST',
            data: formData,
